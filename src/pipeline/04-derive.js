...
const BACKLOG = [
  ...
  {
    id: "P5",
    title: "Calificación automática de elegibilidad en WhatsApp",
    doc: "descubrimientos/05-whatsapp-optimizacion.md",
    hypothesis: "Resolver ciudad + tipo de vivienda en los primeros 2 mensajes libera al asesor humano para cerrar, no para filtrar.",
